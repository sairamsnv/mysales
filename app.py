...
import datetime
df=pd.read_csv(r'https://raw.githubusercontent.com/sairamsnv/mysales/main/vise.csv')
...
def fun():
    ...
    return render_template('sales-prediction.html')
...
def fun1():
    ...
    return render_template('index1.html',value='orders{}'.format(predict))
